...
% dvipdfm.exe na conversão do .dvi para o .pdf. Se você utiliza outra forma de
...
% Sugestão: Gere o pdf utilizando o dvipdfm.exe que converte direto
% de dvi para pdf. Caso contrário, configure adequadamente o pacote hyperref.
...
\usepackage[alf,abnt-emphasize=bf,abnt-etal-text=it,bibjustif,abnt-etal-cite=2,abnt-etal-list=0,recuo=0.5cm]{abntcite}
